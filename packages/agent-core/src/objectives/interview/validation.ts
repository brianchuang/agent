import { ValidationDetail, ObjectiveEventValidator } from "../../core/validation";
...
function mustBeIsoDatetime(field: string, value: string | undefined, issues: ValidationDetail[]): void {
  if (value === undefined) return;
...
export class InterviewEventValidator implements ObjectiveEventValidator {
